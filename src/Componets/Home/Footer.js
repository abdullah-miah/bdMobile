...
const Footer = () => {
    return (
        <div>
           <footer class="footer p-10 bg-base-200 text-base-content px-36 mt-8">
  <div>
...
<footer class="footer px-36 py-4 border-t bg-base-200 text-base-content border-base-300">
  <div class="items-center grid-flow-col">
    ...
    <p>bdMobile Industries Ltd. <br/>Providing reliable tech since 1992</p>
  </div> 
